                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            Wrap(
                              children: List.generate(5, (index){
                                return Icon(Icons.star, color: gottenStar>detail.places.stars?AppColors.starColor:AppColors.textColor2,);
                              }),
                        ...
                        SizedBox(height: 25,),
                        AppLargeText(text: 'Packages', color:Colors.black.withOpacity(0.8), size: 20,),
                        SizedBox(height: 5,),
                        AppText(text: 'Choose packages that fits your requirement',
